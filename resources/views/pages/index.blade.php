...
@extends('core/index')
@section('title', ''.Auth::user()->name.' - Crystal')
@section('page', 'active')
@section('content')
                    ...
                    <div style="margin-bottom:25px;" class="card-body">
                        ...
                        <div class="@php GetLine(Auth::user()->id); @endphp">
                            <div class="text-md-center text-xl-left">
                                ...
                                <p class="text-md mb-0">@php GetCountry(Auth::user()->countryID);@endphp , @php GetCity(Auth::user()->cityID);@endphp</p>
                            </div>
                            <div
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-row justify-content-between">
                                ...
                                <p class="text-muted mb-1">@php echo Auth::user()->name;@endphp</p>
                            </div>
                        </div>
                    </div>
                </div>
